(function () {
  ...
  const numeroWhatsApp = script?.getAttribute('data-whatsapp') || '525554606637';
...
<div id="form-container">
  ...
  <select id="servicio" onchange="verificarCampos()" onblur="validarServicio()">
    <option value="">- ¿Qué actividad te interesa? -</option>
    <option>Bungee soccer</option>
    <option>Realidad virtual</option>
    <option>Tirolesa</option>
    <option>Escalada y rapel</option>
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    window.enviarAWhatsApp = function () {
      ...
      const mensajeWhatsApp =
        `Hola, me gustaría más informació.%0A` +
        `Me llamo: *${nombre}*%0A` +
