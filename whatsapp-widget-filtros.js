(function () {
  ...
  const numeroWhatsApp = script?.getAttribute('data-whatsapp') || '5213350890682';
...
<div id="form-container">
  ...
  <select id="servicio" onchange="verificarCampos()" onblur="validarServicio()">
    ...
    <option>Sistemas de ósmosis inversa</option>
    <option>Desaladores de agua de mar</option>
    <option>Sistemas de ultrafiltración</option>
    <option>Filtros multimedia</option>
    <option>Microfiltración</option>
    <option>Refacciones</option>
    <option>Electrodeionizadores</option>
    <option>Lámparas de Rayos UV</option>
    <option>Generadores de ozono</option>
    <option>Filtros de carbón activado</option>
    <option>Suavizadores</option>
    <option>Desmineralizadores por intercambio iónico</option>
    <option>Otro</option>
  </select>
